		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZLILovio",
									"targetURL": "#myswdswdzlilovion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myswdswdzlilovion-display": {
								"semanticObject": "myswdswdzlilovion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myswd.swd.zlilovion",
									"url": sap.ui.require.toUrl("myswd/swd/zlilovion")
								}
							}
						}
					}
